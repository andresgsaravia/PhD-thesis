...
This basis is infinite dimensional however, as discussed in appendix \ref{chap:comp_details}, for the lower energy excitations the eigenvalues and eigenvectors are well described using a basis with only a few phononic excitations.
