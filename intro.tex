...
% At some point I need to describe why we are intereste in the O(4)-Cu(1)-O(4) cluster and why we use the model we're using
...
In the last section of this introduction (sec. \ref{sec:scope}) we limit the scope of this thesis and present our motivation and approach at describing these dynamic effects.
...
This distribution showed two sites separated by $\sim 0.11 \AA$ that changed into a single site distribution in the vicinity of the superconducting transition temperature. 
