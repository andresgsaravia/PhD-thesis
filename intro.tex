...
This antiferromagnetic phase is rapidly suppresed by charge doping giving rise to superconductivity.
...
In addition to the interplay between antiferromagnetism and superconductivity there is another phase present below a temperature T* which has a rich phenomenology and seems to precede superconductivity for a large part of the phase diagram.
...
This region of phase space has been identified as the \textit{pseudogap phase} and there is evidence for its presence in all cuprate superconductor families and there is evidence for its presence in all cuprate superconductor families \cite{Timusk1999,Muller2007}. 

There are also lattice inhomogeneities in the pseudogap phase, for example in La$_{1.85}$Sr$_{0.15}$CuO$_{4}$ and La$_{2}$CuO$_{4.1}$, the dopant atoms, necessary for superconductivity, do not reside at the crystal symmetric sites making these compounds structurally inhomogeneous \cite{Poccia2011}.
In other cases, like YBa$_2$Cu$_3$O$_{7-\delta}$ (YBCO) the dopant atoms reside in crystal symmetric positions but the departure from stoichiometry produces compositional disorder \cite{Chen1988,Andersen1990} making YBCO also an inhomogeneous system.
...
A perspective of the observation of broken symmetries in high-T$_{c}$ superconductors, emphasizing that some of these broken symmetries are hidden from common observational techniques, is discussed in ref.\cite{Chakravarty2011}. 
